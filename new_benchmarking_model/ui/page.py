"""
New benchmarking model page (isolated add-on).
...
The Streamlit page (pages/5_new_benchmarking.py) is a thin shim that calls render_page().
"""
...
from new_benchmarking_model.ui.config_panel import render_config_panel
from new_benchmarking_model.ui.company_view import render_company_view
...
from new_benchmarking_model.data.loader import load_precomputed_main
...
def render_page() -> None:
    """Render the full new-benchmarking page. Called by pages/5_new_benchmarking.py."""
    init_session_state()
