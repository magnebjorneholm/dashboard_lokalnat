...
(see new_benchmarking_model/config.py).
...
from new_benchmarking_model.components.cable_length import C as cable_C
from new_benchmarking_model.components.environment_capex_adjustment import config as env_C
from new_benchmarking_model.components.station_capex_adjustment import config as st_C
