...
Run directly from anywhere:
    ./venv/Scripts/python.exe new_benchmarking_model/components/station_capex_adjustment/run_example.py
"""
...
from new_benchmarking_model.components.station_capex_adjustment import (  # noqa: E402
