...
reads into new_benchmarking_model/data/precomputed/. At runtime the page loads the bundle
via new_benchmarking_model.data.loader.load_precomputed_main() instead of recomputing.
...
# Ensure project root is on path (this file lives at new_benchmarking_model/data/)
