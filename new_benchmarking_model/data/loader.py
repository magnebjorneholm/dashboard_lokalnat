...
module loads a committed bundle (new_benchmarking_model/data/precomputed/, produced by
new_benchmarking_model/data/precompute.py) and reconstructs the NewBenchmarkingResult the
...
from new_benchmarking_model.totex.capex_environment import EnvCapexResult
from new_benchmarking_model.components.environment_capex_adjustment.adjustment import (
    EnvironmentAdjustmentResult as CableAdjustmentResult,
)
from new_benchmarking_model.components.station_capex_adjustment.adjustment import (
    EnvironmentAdjustmentResult as StationAdjustmentResult,
)

NB_DIR = Path(__file__).resolve().parent / "precomputed"
