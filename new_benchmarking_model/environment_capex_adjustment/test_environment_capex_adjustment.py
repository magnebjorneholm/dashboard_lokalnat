...
Run:
    ./venv/Scripts/python.exe -m pytest new_benchmarking_model/environment_capex_adjustment/test_environment_capex_adjustment.py -v
"""
...
from new_benchmarking_model.environment_capex_adjustment import (
