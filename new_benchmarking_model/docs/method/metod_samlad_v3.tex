...
är vår operationalisering. Myndigheten har offentliggjort sin inriktning i en serie underlag \citep{Ei2025Inriktning, Ei2025Benchmarking, Ei2025Tillampning, Ei2026Effektivisering}, medan flera detaljer
...
och samma kostnadsvariabel \citep{Ei2025Benchmarking}. Skälet är en mer rättvisande jämförelse. Ett företag kan ha högre
...
lägre förlustkostnad sänker den totala kostnaden \citep{Ei2025Tillampning}. I benchmarkingen värderas förlusterna till ett
...
inriktning tillåter att nätförluster, abonnemang eller båda värderas till ett gemensamt pris \citeyearpar{Ei2025Benchmarking}. I
...
som inriktningen namnger uttryckligen \citeyearpar{Ei2025Benchmarking}. Den inkluderas trots att den är svår att påverka på kort
...
försumbart; och en motsvarande korrigering görs för nätstationer \citeyearpar{Ei2025Benchmarking}.
...
den form inriktningen efterfrågar för att slippa detaljerad rapportering per kabeltyp \citeyearpar{Ei2025Benchmarking}. Att
...
inriktningen \citeyearpar{Ei2025Benchmarking}, är att dagens reglering ger incitament att inte investera i för dyra anläggningar men
...
den 75:e percentilen är det per definition den översta fjärdedelen som får full täckning eller mer \citep{Ei2026Effektivisering}.
...
och det finns inget separat generellt effektiviseringskrav i den nya modellen \citeyearpar{Ei2026Effektivisering}.
...
potentialen realiseras över åtta år medan kravet sätts per fyraårig tillsynsperiod \citeyearpar{Ei2026Effektivisering}:
\begin{align*}
  \text{Nuvarande:} \quad
...
uttryckligen en av myndighetens öppna frågor \citeyearpar{Ei2026Effektivisering}.
...
\begin{enumerate}\setcounter{enumi}{2}
  ...
  \item Premien härleds ur normvärdeslistan, medan den kommande metoden riktar sig mot
    anskaffningsvärde \citep{Ei2025Inriktning}, som saknas i nära all tillgänglig data. Härledningen vilar därmed på att
