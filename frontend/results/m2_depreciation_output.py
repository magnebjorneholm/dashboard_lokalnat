...
def _render_category_chart(
    ...
    add_comparison_traces(
        ...
        orientation='h', unit='MSEK', fmt=',.1f',
    )
    ...
    st.plotly_chart(fig, width='stretch', key="m2_category_chart", config={"displayModeBar": False})
...
def _render_halfyear_chart(hy_df: pd.DataFrame, title_label: str) -> None:
    ...
    st.plotly_chart(fig, width='stretch', key="m2_halfyear_chart", config={"displayModeBar": False})