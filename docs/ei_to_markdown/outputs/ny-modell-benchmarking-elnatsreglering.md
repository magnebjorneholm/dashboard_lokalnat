...
DEA-modell med tre variabelgrupper. Kostnader = input, produktion = output, strukturella faktorer = exogena.

De tre grupperna är oberoende listor (ingen radvis koppling mellan kolumnerna).
...
**Produktion (output)**
- Antal uttagspunkter
- Levererad energi — lågspänning
- Levererad energi — högspänning
- Max abonnerad/inmatad effekt

**Strukturella faktorer (exogena)**
- Kundtäthet
  - Antal nätstationer
...
DEA-modell med tre variabelgrupper. Förändringar jämfört med figur 1: kostnader slås ihop till en Totex-post; produktionen kompletteras med levererad energi i gränspunkt; strukturella faktorer utökas med elområde och förläggningsmiljö, och kundtäthet kompletteras med ledningslängd.

De tre grupperna är oberoende listor (ingen radvis koppling mellan kolumnerna).

**Kostnader (input)**
- Totala kostnader (TOTEX)

**Produktion (output)**
- Antal uttagspunkter
- Levererad energi — lågspänning
- Levererad energi — högspänning, gränspunkt
- Max abonnerad/inmatad effekt
...
Förslaget och mer information finns här (länkar på ursprungssidan):
...
- Nytt om effektiviseringsincitamentet i elnätsregleringen
