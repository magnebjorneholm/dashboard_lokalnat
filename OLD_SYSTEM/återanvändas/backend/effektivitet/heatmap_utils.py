...
SHAPEFILE_PATH = "effektivitet/data/Samtliga nätföretags del- och verksamhetsområden.shp"
RECONCILIATION_PATH = "effektivitet/data/reconciliation_id_network_firm_dmu.csv"
...
def load_valid_reid_registry() -> Tuple[Set[str], Set[str], pd.DataFrame]:
    ...
    # Ta bort RER som har motsvarande REL för samma DMU
...
def display_matching_diagnostics(match_stats: Dict, metadata: Dict):
    """
    Visar transparent matchningsdiagnostik.
    """
