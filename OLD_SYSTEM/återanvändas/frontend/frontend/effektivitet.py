...
from effektivitet.backend.ir_export import export_effektiviseringskrav_scenario
from effektivitet.backend.spatial_analysis import calculate_company_neighbor_gap
from effektivitet.frontend.components import (
