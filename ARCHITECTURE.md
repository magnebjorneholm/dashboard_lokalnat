...
|   |   |-- manuals.py            # Host seam for per-tool manuals: published PDF (static/manuals/<slug>.pdf) + builds the in-page reader doc (manual_reader_html) from the Markdown twin (user_manual_latex/manuals/<slug>/main.md), shown on the landing
