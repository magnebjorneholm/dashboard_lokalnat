...
def list_runs():
    os.makedirs("effektivitet/runs", exist_ok=True)
    return sorted(os.listdir("effektivitet/runs"))

def load_run(run_id):
    path = os.path.join("effektivitet/runs", run_id)
